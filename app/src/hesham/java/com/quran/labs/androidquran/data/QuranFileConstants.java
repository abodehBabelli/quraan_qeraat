...
public class QuranFileConstants {
  ...
  public static final String IMG_BASE_URL = BASE_HOST + "hesham/";
  ...
  public static final String AUDIO_DIRECTORY = "hesham/audio/";
  public static final String AYAHINFO_DIRECTORY = "hesham/" + DATABASE_DIRECTORY;
  public static final String IMAGES_DIRECTORY = "hesham";

  // arabic database
  public static final String ARABIC_DATABASE = "quran.hesham.ar.db";
