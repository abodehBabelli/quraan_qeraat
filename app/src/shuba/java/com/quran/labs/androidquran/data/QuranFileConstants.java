...
public class QuranFileConstants {
  ...
  public static final String IMG_BASE_URL = BASE_HOST + "shuba/";
  ...
  public static final String AUDIO_DIRECTORY = "shuba/audio/";
  public static final String AYAHINFO_DIRECTORY = "shuba/" + DATABASE_DIRECTORY;
  public static final String IMAGES_DIRECTORY = "shuba";
